...
func Example() {
	...
	dept_data := []goflat.Set{{"table": "dept", "dept_no": int64(1), "dept_name": "dept1", "active": true}, {"table": "dept", "dept_no": int64(2), "dept_name": "dept2", "active": false}}
	emp_data := []goflat.Set{{"table": "emp", "emp_name": "john", "xdept_no": int64(1)}, {"table": "emp", "emp_name": "bill", "xdept_no": int64(1)}}
